...
class CompanyDirectoryController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html { render :index, layout: "crawler" }
      format.json do
        render json: {
  ...
  def city_category_page
    ...
    respond_to do |format|
      format.html { render :city_category_page, layout: "crawler" }
      format.json do
        render json: {
          city: @city,
          category: @category,
  ...
  def business_profile
    ...
    respond_to do |format|
      format.html { render :business_profile, layout: "crawler" }
      format.json do
        render json: {
  ...
  def my_business
    ...
    respond_to do |format|
      format.html do
        render template: "default/empty", layout: "crawler"
      end
      format.json do
        render json: {
